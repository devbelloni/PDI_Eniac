...
<head>
    ...
    <title>Projeto Integrador 5 - PDI Eniac</title>
...
<body>
    ...
    <main class="projetoDeExtensao1_mainContent">
        <h1 class="projetoDeExtensao1_mainContentTitle">Projeto Integrador 5</h1>
        <!-- formulário de envio -->
        <form class="projetoDeExtensao1_mainContentForm" action="../sql/db_projeto_integrador.php" method="post">
            <label class="projetoDeExtensao_label" for="projectTitleInput">Título</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectTitleInput" name="titulo5" type="text"
                placeholder="<?php echo $obj['titulo5']; ?>">

            <label class="projetoDeExtensao_label1" for="projectLinkInput">Link</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectLinkInput" name="link5" type="text"
                placeholder="<?php echo $obj['link5']; ?>">

            <label class="projetoDeExtensao_label2" for="projectSummaryInput">Resumo</label>
            <textarea class="projetoDeExtensao1_mainContentTextAreaForm" id="projectSummaryInput" name="resumo5"
                cols="30" rows="10" placeholder="<?php echo $obj['resumo5']; ?>"></textarea>
