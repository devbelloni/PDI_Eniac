...
<head>
    ...
    <title>Projeto de Extensão 3 - PDI Eniac</title>
...
<body>
    ...
    <main class="projetoDeExtensao1_mainContent">
        <h1 class="projetoDeExtensao1_mainContentTitle">Projeto de Extensão 3</h1>
        <!-- formulário de envio -->
        <form class="projetoDeExtensao1_mainContentForm" action="../sql/db_outrosProjetos_extensao.php" method="post">
            ...
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectTitleInput" name="tituloOutro3"
                type="text" placeholder="Seu Título armazenado: <?php echo $obj['tituloOutro3']; ?>">

            <label class="projetoDeExtensao_label1" for="projectLinkInput">Link</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectLinkInput" name="linkOutro3" type="text"
                placeholder="Seu Link armazenado: <?php echo $obj['linkOutro3']; ?>">

            <label class="projetoDeExtensao_label2" for="projectSummaryInput">Resumo</label>
            <textarea class="projetoDeExtensao1_mainContentTextAreaForm" id="projectSummaryInput" name="resumoOutro3"
                cols="30" rows="10"
                placeholder="Sua Descrição armazenada: <?php echo $obj['resumoOutro3']; ?>"></textarea>
