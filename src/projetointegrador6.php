...
<head>
    ...
    <title>Projeto Integrador 6 - PDI Eniac</title>
...
<body>
    ...
    <main class="projetoDeExtensao1_mainContent">
        <h1 class="projetoDeExtensao1_mainContentTitle">Projeto Integrador 6</h1>
        <!-- formulário de envio -->
        <form class="projetoDeExtensao1_mainContentForm" action="../sql/db_projeto_integrador.php" method="post">
            ...
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectTitleInput" name="titulo6" type="text"
                placeholder="<?php echo $obj['titulo6']; ?>">

            <label class="projetoDeExtensao_label1" for="projectLinkInput">Link</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectLinkInput" name="link6" type="text"
                placeholder="<?php echo $obj['link6']; ?>">

            <label class="projetoDeExtensao_label2" for="projectSummaryInput">Resumo</label>
            <textarea class="projetoDeExtensao1_mainContentTextAreaForm" id="projectSummaryInput" name="resumo6"
                cols="30" rows="10" placeholder="<?php echo $obj['resumo6']; ?>"></textarea>
