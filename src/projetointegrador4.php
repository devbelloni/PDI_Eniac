...
<head>
    ...
    <title>Projeto Integrador 4 - PDI Eniac</title>
...
<body>
    ...
    <main class="projetoDeExtensao1_mainContent">
        <h1 class="projetoDeExtensao1_mainContentTitle">Projeto Integrador 4</h1>
        <!-- formulário de envio -->
        <form class="projetoDeExtensao1_mainContentForm" action="../sql/db_projeto_integrador.php" method="post">
            ...
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectTitleInput" name="titulo4" type="text"
                placeholder="<?php echo $obj['titulo4']; ?>">

            <label class="projetoDeExtensao_label1" for="projectLinkInput">Link</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectLinkInput" name="link4" type="text"
                placeholder="<?php echo $obj['link4']; ?>">

            <label class="projetoDeExtensao_label2" for="projectSummaryInput">Resumo</label>
            <textarea class="projetoDeExtensao1_mainContentTextAreaForm" id="projectSummaryInput" name="resumo4"
                cols="30" rows="10" placeholder="<?php echo $obj['resumo4']; ?>"></textarea>
