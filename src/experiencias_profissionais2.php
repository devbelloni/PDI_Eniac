        ...
        <div id="exp1_card">
            <article id="">
                <form class="formu" action="../sql/db_experiencias_profissionais.php" method="post">
                    <br>
                    <h2>Experiência Profissional 2</h2>
                    <br><br>
                    <section>
                        <p id="exp1_nome"> Nome da Empresa:</p>
                        <div id="exp1_input1">
                            <input id="exp1_input" name="empresa2" value="" placeholder="" required>
                        </div>
                        <br>
                        <p id="exp1_nome">Função:</p>
                        <div id="exp1_input1">
                            <input id="exp1_input" name="funcao2" value="" placeholder="" required>
                            <div>
                                <br>
                                <p id="exp1_nome">Data de entrada:</p>
                                <div id="exp1_input1">
                                    <input id="exp1_input" name="entrada2" value="" type="date" placeholder="xx/xx/xxxx"
                                        required>
                                </div>
                                <br>
                                <p id="exp1_nome">Data de saída(Caso continue na empresa desconsiderar):</p>
                                <div id="exp1_input1">
                                    <input id="exp1_input" name="saida2" value="" type="date" placeholder="xx/xx/xxxx">
                                </div>
                                <br>
                                <br>
