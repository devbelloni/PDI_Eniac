    ...
    <section>
        ...
        <article id="div">
            <form action="../sql/db_trabalho_voluntario.php" method="post">
                <br>
                <br>
                <h2 id="voluntario1_h2">Trabalho Voluntário 1</h2>
                <br><br>

                <p id="voluntario1_p"> Tema do trabalho como voluntário:</p>
                <div>
                    <input id="voluntario1_input" name="tema_voluntario1" value="" placeholder="" required>
                </div><br>
                <p id="voluntario1_p">Atividades exercidas:</p>
                <div>
                    <input id="voluntario1_input" name="descricao_voluntario1" value="" placeholder="" required>
                </div><br>
                <p id="voluntario1_p">Data:</p>
                <div>
                    <input id="voluntario1_input" name="data_voluntario1" value="" type="date" placeholder="xx/xx/xxxx"
                        required>
                </div><br> <br>
                <div>
                    <br>
