...
$query = ("SELECT * FROM cadastro_adm");
...
if (!empty($_GET['search'])) {
  ...
  $data = $_GET['search'];
  $sql = ("SELECT * FROM cadastro_adm where idcadastro_adm  LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY idcadastro_adm ASC");


} else {
  $sql = ("SELECT * FROM cadastro_adm ORDER BY nome ASC ");
...
<body>
  ...
  <script>
    ...
    function searchDate() {
      window.location = 'mostrar_adm.php?search=' + search.value;
