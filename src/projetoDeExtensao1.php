...
<head>
    ...
    <title>Projeto de Extensão 1 - PDI Eniac</title>
...
<body>
    ...
    <main class="projetoDeExtensao1_mainContent">
        <h1 class="projetoDeExtensao1_mainContentTitle">Projeto de Extensão 1</h1>
        <!-- formulário de envio -->
        <form class="projetoDeExtensao1_mainContentForm" action="../sql/db_outrosProjetos_extensao.php" method="post">
            ...
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectTitleInput" name="titiloOutro1"
                type="text" placeholder="Seu Título armazenado: <?php echo $obj['tituloOutro1']; ?>">

            <label class="projetoDeExtensao_label1" for="projectLinkInput">Link</label>
            <input class="projetoDeExtensao1_mainContentInputForm" id="projectLinkInput" name="linkOutro1" type="text"
                placeholder="Seu Link armazenado: <?php echo $obj['linkOutro1']; ?>">

            <label class="projetoDeExtensao_label2" for="projectSummaryInput">Resumo</label>
            <textarea class="projetoDeExtensao1_mainContentTextAreaForm" id="projectSummaryInput" name="resumoOutro1"
                cols="30" rows="10"
                placeholder="Sua Descrição armazenada: <?php echo $obj['resumoOutro1']; ?>"></textarea>
